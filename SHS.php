...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-8">
				<h1 class="page-header"><p> Senior High School Tracks</h1>
			</div>
		</div>	
		...
		<div class="jumbotron">
			...
			<ul>
				...
				<li>ABM Strand with focus on Hospitality and Tourism</li>
				<li>General Academic (GA) Strand</li>
				<li>GA Strand with focus on Criminology</li>
				<li>GA Strand with focus on Education</li>
				<li>GA Strand with focus on Information Technology</li>
				<li>Humanities and Social Science (HUMSS) Strand</li>
				<li>Science, Technology, Engineering, and Mathematics (STEM) Strand</li>
				<li>STEM Strand with focus on Health</li>
			</ul>
		</div>
		<div class="jumbotron">
			<h3>Technical-Vocational-Livelihood (TVL) Track:</h3>
			<ul>
				<li>Home Economics (HE) Strand with focus on Hospitality(Bread and Pastry, Household Services, Food and Beverages, Cookery/Commercial Cooking</li>
				<li>HE Strand with focus on Tourism(Tour Guiding, Tourism Services, Attraction and Theme Parks)</li>
				<li>HE Strand with focus on Caregiving</li>
				<li>Information and Communications Technology (ICT) Strand(Animation, Computer Hardware Servicing, Computer Programming)</li>
				<li>Industrial Arts Strand (Automotive Servicing, Bookkeeping)</li>
			</ul>
		</div>
